...
<body>
			...
			<div class="slide-area">
				...
				<div class="slide-wrap">
					...
					<div class="text-area">
						...
						<div class="text-line text-group" style="height:100px">
							<textarea id="test_msg" cols="30" rows="10" style="width:166px;height:100px"></textarea>
						</div>
	...
	<script>
		...
		// })
		var backKey	= 0;
		$('#test_msg').on('keyup', function(e) {
			var this_val 	= $(this).val();
			this_val = this_val.replace(/\r\n/g, '"<"br">"');
			this_val = this_val.replace(/\n/g, '"<"br">"');
			this_val = this_val.replace(/\r/g, '"<"br">"');
